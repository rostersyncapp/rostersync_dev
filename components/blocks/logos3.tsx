...
const DEFAULT_LOGOS: Logo[] = [
    ...
    { id: "ncaa", description: "NCAA", image: "https://rddqcxfalrlmlvirjlca.supabase.co/storage/v1/object/public/logos/league_logos/ncaa.png", className: "h-12 w-auto grayscale opacity-50 hover:opacity-100 hover:grayscale-0 transition-all duration-300" },
];
