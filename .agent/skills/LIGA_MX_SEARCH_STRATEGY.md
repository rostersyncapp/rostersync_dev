...
- **Implicit**: We rely on standard Liga MX team names being present in `ESPN_TEAM_IDS` or `KNOWN_TEAM_LOGOS`.
- **Ambiguity**: Liga MX teams score **3 points** in priority resolving.
